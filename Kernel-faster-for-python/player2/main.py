...
import networkx as nx  # TODO: ignore this library (faster run speed)
import random


# TODO: we have different strategics
# - Tortoise Defense System
# - Just Destroy Strategic nodes
...
def get_game_graph(game):
    adjacents = {int(key): value for key, value in game.get_adj().items()}
    return nx.Graph(adjacents)
